...
import com.herren.hejabox.domain.OrderStatus;
...
public class OrderServiceTest {
    ...
    // 좋은 테스트는 DB Dependency 없이 순수하게 단위테스트 하는 게 좋다.
    // 목적은 jpa가 잘 작동하는지
    ...
    public void 상품주문() throws Exception {
        //given
//        Member member = new Member(); // 테스트 멤버
//        member.setName("회원1");
//        member.setAddress(new Address("서울", "강가", "123-123"));
//        em.persist(member);
        // 위에거 ctrl + alt + m해서 아래로 바꿔줌
    ...
    public void 주문취소() throws Exception {
        ...
        // 주문 취소를 하는 것이기 때문에 given절에서 이게 들어가는 게 맞다.
